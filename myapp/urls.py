...
from myapp.views import get_weatherinfo_base, get_weatherinfo_all, register, sendcode, wy_login, geturl, add_href, \
    delete_href
...
urlpatterns = [
    ...
    re_path(r'^wy_login/$', wy_login.as_view(), name="api"),
